<?php
/*
Template Name: Forms-query-ajax
*/
...
<a href="https://oferta-certificacion.aenor.com/wp-admin/" style="display:flex;justify-content:center;">
    ...
    <header>
        <h1 style="color: #1F56A2; font-weight: 900; text-align: center;">
            Privado: Informe de todas las certificaciones (AJAX)
        </h1>
    </header>
...
let table = new DataTable('#tabla-resultados', {
    ...
    ajax: {
        ...
        beforeSend: function () {
            ...
            document.getElementById('tabla-resultados_info').style.visibility = 'hidden'
        },
        complete: function () {
            ...
            document.getElementById('tabla-resultados_info').style.visibility = 'unset'
        }
    },
    deferRender: true,
        ...
        },
        {
            ...
            render: function (data,type, row) {
                if ( type === 'display' || type === 'filter' ) {
                    ...
                    const dia = curDate.getDate();
                    const mes = curDate.getMonth()+1;
                    const fecha = curDate.getFullYear();
